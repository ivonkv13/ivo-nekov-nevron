...
- Create Angular project with ng: `ng new interviewtask.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`interviewtask.client.esproj`).
